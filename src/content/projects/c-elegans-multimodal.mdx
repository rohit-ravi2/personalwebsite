...
Honest calibration notes are in the component's "Sources & attribution" fold. The main v1 limitation is that classifiers were trained on Atanas ΔF/F imaging while closed-loop input is synthetic calcium from Brian2 spike trains — the distributions don't perfectly match, so transition thresholds were empirically recalibrated. Per-edge receptor mapping beyond the 22 sign overrides documented in the brain module is still outstanding and will be the main Phase 3 v2 work.
