...
## Cross-phylum validation (V4 + V6) — three organisms, 12 / 12 gates pass

Same architecture transferred to *Drosophila larva* (Winding 2023 connectome, 2,952 neurons) and then to *Mus musculus* (generic LIF random graph, 3,000 neurons — no mammalian connectome required per V5 M2 finding). Three organisms across two phyla (protostome invertebrate → deuterostome vertebrate), three independent calibrations on a single behavioral anchor each.

| Gate | worm V3 (Cook 2019) | fly V4 (Winding 2023) | mouse V6 (random graph) |
|---|---|---|---|
| 1 — halothane WT calibration | 317 µM (1.07× off published 340) | 361 µM (**1.06×** off 340) | 297 µM (**1.18×** off 350) |
| 2 — held-out volatile (isoflurane) | 291 µM (1.002× off 290) | 323 µM (**1.11×** off 290) | 273 µM (**1.06×** off 290) |
| 3 — mutant directional accuracy | 9 / 9 (100%) | **13 / 13** (100%) | **10 / 10** (100%) |
| 4 — Eger non-immobilizer specificity | 3 / 3 | **3 / 3** | **3 / 3** |
| α (free parameter, single-anchor calibration) | 0.13 | 0.060 | 0.10 |

**Cross-phylum aggregate**: 32/32 directional mutant predictions correct, 9/9 Eger compounds correctly classified, 11/12 WT calibrations within 2× of published, across nematode + dipteran + mammalian substrates.

**Striking conservation**: halothane MAC at ~340-350 µM aqueous concentration in *all three* organisms (Crowder 1996 worm, van Swinderen 1999 fly, Sonner 1999 mouse). Same molecules, same conserved targets, same effective behavioral threshold across phyla.

The same Hill-curve perturbation table (mammalian-receptor electrophys EC50s) integrates correctly across:
- Worm orthologs (UNC-49 GABA-A / TWK-18 K2P / GAS-1 Complex I / UNC-64 SNARE / UNC-79 NCA)
- Fly orthologs (Rdl / Sandman / ND-49 / Syx1A / dunc-79)
- Mouse natives (α1β2γ2 / TREK-1, TASK-1, TASK-3 / Complex I / NMJ syntaxin / NALCN)

The conserved-substrate hypothesis is dispositive across two phyla. The mechanism map (literature-anchored Hill perturbation across conserved targets) is what does the work — confirmed in three independently calibrated organism substrates.

**Honest scope note for V6 mouse**: tests only the LRR / immobilization phenotype. Higher-order mammalian features (cortical EEG burst suppression, NREM-like slow oscillations, gamma suppression, consciousness disruption) are NOT in the architecture and must NOT be claimed.

Use the **Cross-Species** tab in the interactive above to compare worm + fly + mouse halothane / isoflurane curves side-by-side.
