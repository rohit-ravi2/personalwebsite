...
## Cross-species validation (V4) — fly larva, 4 / 4 gates pass

Same architecture transferred to *Drosophila larva* via the Winding 2023 connectome (2,952 neurons, ~110,000 chemical edges) plus a fly-specific cell-type-based NT-identity heuristic and α calibrated on the single van Swinderen 1999 halothane LRR anchor.

| Gate | worm V3 (Cook 2019, 300 neurons) | fly V4 (Winding 2023, 2,952 neurons) |
|---|---|---|
| 1 — halothane WT calibration | 317 µM (1.07× off published 340) | 361 µM (**1.06×** off published 340) |
| 2 — isoflurane WT held-out | 291 µM (1.002× off published 290) | 323 µM (**1.11×** off published 290) |
| 3 — mutant directional accuracy | 9 / 9 (100%) | **13 / 13 (100%)** |
| 4 — Eger non-immobilizer specificity | 3 / 3 | **3 / 3** |
| α (free parameter, calibrated on one anchor) | 0.13 | 0.060 |

The same Hill-curve perturbation table (mammalian-receptor electrophys EC50s) extrapolates to fly orthologs (Syx1A / Sandman / ND-49 / Goα47A / Rdl / GluClα / Dα-Dβ) the same way it extrapolates to worm orthologs. Compounds that immobilize *C. elegans* immobilize *Drosophila larva* in the model. Compounds that fail in worm (Eger non-immobilizers) fail in fly. The conserved-substrate hypothesis is dispositive across two organisms with ~10× different neuron counts and ~30× different edge counts.

Use the **Cross-Species** tab in the interactive above to compare the worm and fly halothane / isoflurane curves side-by-side.
